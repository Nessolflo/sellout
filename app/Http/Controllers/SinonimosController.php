...
use DB;
use Exception;
class SinonimosController extends Controller
{
	...
	public function index(){
		try{
			...
			$this->result = true;
			$this->records = Sinonimos::with("modelo")->get();
		}catch(\Exception $e){
	...
	public function destroy($id){
		try{
            ...
            $this->result = true;
            $this->records = Sinonimos::destroy($id);
		}catch(\Exception $e){
